...
# Set the specific hotel for this dashboard
HOTEL_NAME = "St Albans"  # Change this for each hotel's dashboard
...
# KPI section using st.metric
    ...
    st.markdown("""
    <div class="champion-container">
        <img src="https://ui-avatars.com/api/?name=Suleman&background=10B981&color=fff&size=100" class="champion-photo">
        <div class="champion-info">
            <h3>Suleman</h3>
            <p>"Let's outperform our target! Find me at reception for energy-saving tips."</p>
        </div>
